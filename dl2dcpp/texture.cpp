...
GLuint loadTGA(/*TextureImage *texture, */const char * imagepath)
{
	...
	FILE *file = fopen(imagepath, "rb");						// Open The TGA File
	...
	unsigned char * imageData = (GLubyte *)malloc(imageSize);		// Reserve Memory To Hold The TGA Data
	...
	GLuint texID;							// Build A Texture From The Data
